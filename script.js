...
document
  .querySelectorAll(
    '.section-header, .about-content, .skill-category, .timeline-item, .education-card, .project-card, .contact-content'
  )
  .forEach(el => {
...
function animateSkillBars(skillCategory) {
  if (animatedSkills.has(skillCategory)) return;
  animatedSkills.add(skillCategory);
...
console.log(
  "%c👋 Welcome to Dana Issa's Portfolio",
